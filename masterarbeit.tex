...
Oft ergeben die zwei Präzedenzregeln keine eindeutige Reihenfolge, zum Beispiel wenn Animal neben Thing noch eine weitere Superklasse Creature hat (Abb. \ref{creature}). 
\begin{figure}[h]
 \centering
