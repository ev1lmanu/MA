...
Der Fall, dass keine Reihenfolge alle Constraints erfüllt, tritt auf, wenn zwei Oberklassen gegensätzliche Vererbungsreihenfolgen haben. Das ist zum Beispiel gegeben, wenn wir per Hand einer der Klassen Creature oder Thing vor den Klassen Element und Animal in der Klassendefinition anführen:
...
In dem Fall signalisiert CLOS einen Fehler, das es keine Klassenpräzedenzliste erstellen kann, die konsistent mit allen Constraints ist.
