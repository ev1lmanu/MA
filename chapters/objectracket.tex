...
\begin{tabular}{|c'c|c|c|c|c}
 \hline
		& \multicolumn{1}{p{2cm}|}{\centering overrides method} 
		& \multicolumn{1}{p{2cm}|}{\centering augments method}
		& \multicolumn{1}{p{2cm}|}{\centering can be overridden}
		& \multicolumn{1}{p{2cm}|}{\centering can be augmented}
		\\ \thickhline
