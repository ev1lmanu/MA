...
%  \item TODO welche Arten von OOP haben sich etabliert? Kernpunkte der Objektsysteme
...
In dieser Arbeit soll untersucht werden, ob das Metaobjekt-Protokoll auch genutzt werden kann, um Verhalten von CLOS zu dem bestehenden Objektsystem von Racket hinzuzufügen. 

Dabei soll eine Spracherweiterung entstehen, die in der Lehre des Moduls ``Softwareentwicklung III'' genutzt werden kann. Der Fokus liegt daher auf für die Lehre relevanten Konzepten: Mehrfachvererbung, Klassenpräzedenz, Methodenkombination und Ergänzungsmethoden.
