...
\begin{enumerate}
 \item Bestehender Code in Object-Racket soll weiterhin genauso funkztionieren wie vorher. Die Erweiterung soll keinen Einfluss auf bestehenden Racket-Code haben. Funktionalität, die das Objektsystem zur Zeit bietet, soll auch nach dem Hinzufügen der Features auf dieselbe Art funktionieren und das gleiche Ergebnis liefern.
