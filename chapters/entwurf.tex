...
Option 2b, eine simple Veränderung der Klassenoptionen, die an das Makro übergeben werden, löst all diese Probleme, erzeugt jedoch eine andere Herausforderung: Mehrfachvererbung und Methodenkombination rein auf Syntaxebene zu implementieren. Felder oder Methoden können nicht einfach ausgewertet werden; die Erzeugung all dieser Dinge übernimmt Object-Racket schließlich. Das heißt, allein anhand der Syntax, in das \texttt{class}-Makro injiziert wird (oder daraus entfernen), muss Mehrfachvererbung erreicht werden.
