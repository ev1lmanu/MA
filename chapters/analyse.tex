...
\begin{itemize}
 ...
 \item Die Support-Schicht: Hier ist das Verhalten von Klassen, Instanzen, generischen Funktionen und Methoden implementiert. Das Metaobjektprotokoll konzentriert sich hauptsächlich auf diese Schicht.
\end{itemize}
...
Es gibt demnach eine Tabelle von Klassenmetaobjekten, die bereits erstellt wurden, eine Funktion zum Abfragen, ob ein Objekt bereits existiert sowie eine Funktion zum Hinzufügen eines Objekts:
